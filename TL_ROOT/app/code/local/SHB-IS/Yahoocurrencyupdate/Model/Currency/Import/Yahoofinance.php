<?php
    /**
     * Currency import model (From quote.yahoo.com)
     *
     * @category   Rw
     * @package    Rw_Yahoocurrencyupdate
     * @author     Reizwerk GmbH
     */
    class Rw_Yahoocurrencyupdate_Model_Currency_Import_Yahoofinance extends Mage_Directory_Model_Currency_Import_Abstract
    {
